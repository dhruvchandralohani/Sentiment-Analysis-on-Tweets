...
pos.words <- scan('/home/dhruv/Desktop/Introduction to Data Sciences/Programs/positive_words.txt' , what = 'character' , comment.char = ';')
neg.words <- scan('/home/dhruv/Desktop/Introduction to Data Sciences/Programs/negative_words.txt' , what = 'character' , comment.char = ';')
